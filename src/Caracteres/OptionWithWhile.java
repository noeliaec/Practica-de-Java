...
public class OptionWithWhile {
    public static void main (String[] args) {
        ...
        final String OPTION_4 = "4"; //Definir Constantes: Se definen constantes para las opciones y el valor de π (PI).
        ...
        while (!opcion.equals(OPTION_4) && !opcion.equals("D") && !opcion.equals("d")) {
            System.out.print(
                    "Elige una opción: \n\n"
                            + "1 o A) Rectángulo\n"
                            + "2 o B) Círculo\n"
